...
As we expect conditional accuracies ranging between (and including) 0 and 1, we use a flat prior on the logit scale for our intercepts (see Supplementary Figure 8 in section H of the Supplemental Material).
