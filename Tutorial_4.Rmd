...
However, if we were doing this for real, we would probably choose different priors that are similar to ones that were discussed in Tutorial_2a as well as in Supplmentary Materials.
