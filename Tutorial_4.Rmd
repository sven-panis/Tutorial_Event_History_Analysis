...
```{r load-osf-sim1, eval=F}
## create a relevant folder
dir.create("Tutorial_4_planning/data/sim1/")

## read in the data from the OSF and store it in a relevant folder
osf_sim1_data <-
  ...
  osf_download(path = "./Tutorial_4_planning/data/sim1/")
```
...
```{r load-osf-sim2, eval=F}
## create a relevant folder
dir.create("Tutorial_4_planning/data/sim2/")
...
osf_sim2_data <-
  ...
  osf_download(path = "./Tutorial_4_planning/data/sim2/")
```
