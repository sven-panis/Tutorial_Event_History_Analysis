...
Now use add_predicted_draws() to simulate prior-based data for 10 bins and 6 subjects, while taking into account samples from the priors for the standard deviation of the random effects, and correlations between parameters.
