...
Because TIME is centered on bin 9, the Intercept represents the estimated cloglog-hazard in bin 9 for the blank prime condition. Model_M1d took about 184 minutes to run. Note that duplicate terms in the model formula (e.g., condition) are ignored.
