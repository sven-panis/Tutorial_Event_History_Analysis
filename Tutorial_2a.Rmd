...
Prepare the data file, and specify priors. To find the priors, we performed a prior predictive check which is reported in section 8.2.
...
```{r save-post, eval=F}
ggsave("Tutorial_2_Bayesian/figures/M1i_postdistr_alt3.png", width = 10, height = 8, dpi = 800)
```
...
Following Heiss (2021), we can plot the expected value of the posterior predictive distribution -- the predicted hazard values -- for the average participant, and for each participant in the data set.
