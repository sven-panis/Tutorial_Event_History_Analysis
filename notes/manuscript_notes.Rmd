...
- check legends of all Figures, and add more info if needed -> Done

- make loo plots (I did not find code to do that. Do you have a reference for such code?)

- add info on simulation and power analysis (section 4.4 + summary in section 4). Done.

- delete code in Tutorial_2a about brand new hypothetical subject? Done.

- use timebin or time bins? Timebin.

- use multi-level or multilevel ? Multilevel.
...
Gelman, A., Vehtari, A., Simpson, D., Margossian, C. C., Carpenter, B., Yao, Y., Kennedy, L., Gabry, J., Bürkner, P.-C., & Modrák, M. (2020). Bayesian Workflow (arXiv:2011.01808). arXiv. http://arxiv.org/abs/2011.01808
Kurz, A. S. https://solomonkurz.netlify.app/blog/bayesian-power-analysis-part-i/
...
-> Model M1d removed from main text.
...
2. As (1) combine Figures 8 and 9. (ames)
...
-> Title removed before combining with Figure 7.


Figure 9. spell out AMEs in full to avoid jargon.

-> AMEs was removed before combining with fig 8.
...
# Sven dec 10 still to do:

adjust small error in Figure 3 

-> Done.

check Figure 10 + add second panel to Figure 10

-> Done.

change ms code in section 4.1.2 (make it same as in tut)

-> Done.

appendix/separate Rmd file... + {var} in functions...?

-> separate supplementary.Rmd created.


clean up html files 2a (delete old figures, 

-> Done.

Mention tut 2b priors line 101, ...)
-> Done.


change Figure comparison for ca

-> Done.

Change grand average to population-level  and participant-level 
...
check for timebin -> time bin

-> 20 minutes:  Figure 1 and Figure 2!!! 3,  6,  7   9.  10.  

Cover letter, reviewers, PsychArchiv

-> 2 hours : sunday

Add Disclosures to ms.    CREDIT. and. No conflict of interest... + link psycharchiv + github
...
-> Done.   !!!!!! Tutorial 4 -> eval=F in general settings !!!!!!!!




Create combined file (ms + supps) for PsychArxiv
...
Submit to Advances in Methods and Practices in Psychological Science
...
in the main text, change to Supplementary Figure X (as appropriate). 
e.g., page 28, Figure 15 when talking about priors.

-> Done.

## figure 11 ##

very minor point. I would make figure smaller in height. There is a lot of white space and a shorter plot woudl still communicate the main message. 
I would also fatten the point and the lines to make them easier to see.
Add more dodge if necessary.
...
>Statistically controlling for the passage of time during data analysis is equally important as experimental control during the design of an experiment, to better understand human behavior in experimental paradigms.

But I don't think we need it, and I don't understand the second half of the sentence. If we do need it, we need to make it clear what it means.
