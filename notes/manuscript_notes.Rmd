...
- REF for time-to-death (line 127 in ms.)

- REF for reviews and tutorials on EHA (line 140)

- REF for regression (line 145)

- change paragraph (delete it and refer to suppl. material?), and add error bars to Figure 2? (line 162)

- update section 3 and add REFs (line 200-215)

- REF sampling bias (line 332)

- REF for package MASS (line 665)

- REF for prevalence (line 710)

-frequentist versus Bayesian plot: which intervals should we plot for the frequentist model?

- summary of steps involved in tutorials
