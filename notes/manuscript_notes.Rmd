...
-> I added a content list at the start of each Tutorial_x.Rmd file.
...
-> I expected problems with fitting the very complex model M4. But even M3 has problems.
...
-> I prefer the last option. I created a new figure 3.
...
-> I think it is important for naive readers to get an idea of how the variables in the models presented later are calculated. 
...
-> Explanation for large values is given in the table captions.  todo
...
-> I prefere option 1, and added a new subsection... todo
