...
- add figures of the prior predictive checks in Tutorial_2a.html

- add refs for some websites I consulted

- check the references in the ms to various parts of the supplementary material
...
- add info on simulation and power analysis (section 4.4)
