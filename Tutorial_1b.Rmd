...
Tutorial 1b illustrates how to use functional programming to set up life tables, and plot the discrete-time hazard, survivor, and conditional accuracy functions, for the data of Experiment 1 of Panis and Schmidt (2016) when there are TWO independent variables (here: mask type and prime type).
...
map2(paste0("Tutorial_1_descriptive_stats/figures/Plot_2IV_for_subject", data_final$pid, "_PanisSchmidt.png"), data_final$plot, ggsave, width = 12, height = 10, dpi = 800)
```
