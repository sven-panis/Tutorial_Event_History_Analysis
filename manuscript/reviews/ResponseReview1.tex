...
Response:TODO. To improve the Figure (figure number 2 in the revised
ms.). However, we added bin 40 in the revised ms.
...
file. We also included a brief description of a life table and how to
interpret the plot in the R Markdown tutorial files. At this point, we
also prefer a modular approach to the tutorials rather than combining
them. We appreciate that not everyone might share this preference, but
we think there are many benefits to a modular workflow in this instance.
...
vs.~distributional shapes. We also discuss research questions on page 10
of the revised ms.
...
We now removed these messages from the paper and mention them now only
