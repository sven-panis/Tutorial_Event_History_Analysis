...
direct the reader to the Tutorials on page 37 of the revised ms.

We mention in Tutorials 3a and 3b that it is common for models to fail
to converge in lme4 when they have a reasonably complex random effects
structure.
