...
\caption{(ref:descr-plot-RT-tasks-caption)}\label{fig:plot-RT-tasks}
\end{figure}
...
\subsection{B. Describe the shape of a distribution of time-to-event data: h(t), S(t), P(t) and F(t)}\label{b.-describe-the-shape-of-a-distribution-of-time-to-event-data-ht-st-pt-and-ft}
...
\subsection{C Modeling approaches}\label{c-modeling-approaches}
