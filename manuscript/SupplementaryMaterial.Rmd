...
(ref:descr-plot15-caption) The logit and cloglog link functions.
 
```{r plot-link-functions, fig.cap = "(ref:descr-plot15-caption)", out.width='80%'}
...
(ref:descr-plot16-caption) Prior distributions for the Intercept on the logit and/or cloglog scales (middle column), and their implications on the probability scale after applying the inverse-logit (or logistic) transformation (left column), and the inverse-cloglog transformation (right column).

```{r plot-priors, fig.cap = "(ref:descr-plot16-caption)", out.width='80%'}
