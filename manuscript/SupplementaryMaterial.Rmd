...
* calc_ca_2IV(df)
* join_lt_ca(df1,df2)
* join_lt_ca_2IV(df1,df2)
* extract_median(df)
* extract_median_2IV(df)
* plot_eha(df,subj,haz_yaxis)
* plot_eha_2IV(df,subj,haz_yaxis)
* plot_eha_agg(df,subj,haz_yaxis)
