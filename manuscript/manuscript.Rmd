...
In Section 2, we provide a brief overview of EHA, including basic concepts, modeling approaches, the new types of research questions that EHA allows to answer about behavioral dynamics.
...
EHA is a class of statistical approaches to study the occurrence and timing of events, such as disease onset, marriages, arrests, and job terminations [@allisonSurvivalAnalysisUsing2010]. 
...
In standard applications, each individual can experience the event only once. In experimental psychology and cognitive neuroscience, however, most events are repeatable, and ... trials !!
...
Rt always continuous

but: see DECISION TREE
...
We refer to this extended (hazard + conditional accuracy) analysis for choice RT data as EHA/SAT. The mathematical definitions of these and other discrete-time functions are given in section B of the Supplemental Material.
