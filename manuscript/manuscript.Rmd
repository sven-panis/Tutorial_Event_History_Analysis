...
The hazard models in this tutorial assume that there is one event of interest. However, in certain situations, more than one event of interest might exist. For example, ... - multi-state hazard models refs
