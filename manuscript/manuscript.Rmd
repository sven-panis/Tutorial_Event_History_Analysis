...
In addition, we also supply a set of custom-built functions, which make the process of data wrangling in the context of descriptive EHA a lot quicker and more efficient.
...
We can compare the three models using the Widely Applicable Information Criterion (WAIC) and Leave-One-Out (LOO) cross-validation, and look at model weights for both criteria [@mcelreathStatisticalRethinkingBayesian2020; @kurzAppliedLongitudinalDataAnalysis2023].
