...
wordcount         : "10115 (body) + 1764 (references) + 3442 (body supplemental material) + 393 (refs suppl. mat.)"
bibliography      : ["extrareferences.bib", "extrareferences2.bib", "r-references.bib"]
floatsintext      : yes
linenumbers       : yes
draft             : no
mask              : no
...
# R references
 ...
 my_r_citation <- cite_r(file = "r-references.bib", footnote = TRUE) # use in main text to cite R 
...
```{r plot-fixed-effects, fig.cap = "(ref:descr-plot3-caption)", out.height='87%', out.width='90%'}
...
(ref:descr-plot6-caption) Conditional accuracy modeling results. (A) Medians and 80/95% credible intervals of the posterior distributions of the population-level parameters of model M1i_ca. (B) Point (median) and 80/95% credible interval summaries of the conditional accuracy (ca) estimates (expected values of the draws from the posterior predictive distributions) in each time bin at the population level. (C) Point (mean) and 80/95% credible interval summaries of estimated differences in conditional accuracy in each time bin at the population level.

```{r plot-ca-fixed-effects, fig.cap = "(ref:descr-plot6-caption)", out.height='87%', out.width='90%'}
