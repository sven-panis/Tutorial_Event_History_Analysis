...
wordcount         : "10082 (body) + 1764 (references) + 3442 ( body supplemental material) + 393 (refs suppl. mat.)"
...
<!--present the sample-based functions for each participant as part of Tutorial_1b.Rmd for those that are interested.-->
...
```{r plot-ca-fixed-effects, fig.cap = "(ref:descr-plot6-caption)", out.width='90%'}
