...
The general approach to planning that we adopt here involves simulating data to help guide what you might be able to expect from your data once you collect it [@gelmanBayesianWorkflow2020].
The basic structure and code follows the examples outlined by Solomon Kurz in his
'power' blog posts (https://solomonkurz.netlify.app/blog/bayesian-power-analysis-part-i/) and Lisa Debruine's R package faux{} (https://debruine.github.io/faux/) as well as the related paper [@debruineUnderstandingMixedEffectsModels2021]. 
...
(ref:simdat-plot15-caption) Raw data from @panisWhatShapingRT2016 and simulated data from 10 participants.
...
We might pick a hazard ratio of 0.4 or 0.5 as a target effect size since this is much smaller than that observed in the previously published study that this work is building upon [@panisWhatShapingRT2016].
