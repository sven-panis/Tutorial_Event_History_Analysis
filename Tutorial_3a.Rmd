...
# 3. Fit hazard model in the frequentist framework (model_M1i_f)
...
p1 <- ggplot(data = est, aes(x = position)) +
  ...
  geom_linerange(
    aes(
      ymin = glmer$conf.low, ymax = glmer$conf.high,
      color = "c2"
    ),
    show.legend = F,
    linewidth = 1.2,
