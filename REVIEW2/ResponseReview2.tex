...
questions. Overall, we feel these choices strike a nice balance in terms
of accessibility. We do not want the paper to become overly long and
technical, but we also want to provide a clear description of key terms,
concepts and relevant equations.
...
Response: We re-wrote this sentence\ldots. TODO
...
Response: We corrected this\ldots\ldots{} TODO
...
discrete-time EHA and note that ``there are no strict cutoffs for when
data should be treated as discrete versus continuous''.
...
Response: We discuss the distinction now on page x of the revised
ms\ldots.. TODO
