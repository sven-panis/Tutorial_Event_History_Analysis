...
Response: We define and explain key concepts (by adding a glossary) and
research design features in the main text now.
...
and analytic guidance into the main text.
...
Response. We now present the descriptions of RT data, research
questions, and analytic approaches in the main text. Nevertheless, we
still opted to keep the text equation-light, to increase accessibility
for non-mathematical psychologists. We also added various new sections
